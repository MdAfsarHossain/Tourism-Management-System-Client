    ...
    <div className="px-10 py-10 flex flex-row gap-10 justify-normal items-center">
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl shadow-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <button className="block w-full p-3 text-center rounded-lg text-white uppercase bg-blue-500  border-2 border-blue-500 hover:bg-transparent hover:border-blue-500 hover:text-blue-500 font-bold">
            Register
          </button>
        </form>
